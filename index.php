...
$domande = [
    ...
    [
        ...
        <p> Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel Centro <a href="https://www.google.com/safetycenter/">Centro Google per la sicurezza online</a>.</p>
...
<div class="container">
    <nav>
        <div class="bar1">
            <div class="bar1-left">
                <div class="immagine">
                    <img class="immagine" src="./img/google_logo-696x265.png" alt="">
                </div>
    ...
    <div class="bar-down">
        <div class="info">Introduzione</div>
        <div class="info">Norme sulla privacy</div>
        <div class="info">Termini di servizio</div>
        <div class="info">Tecnologie</div>
        <div class="info">Domande Frequenti</div>
        
    </div>
    <div class="box">
        <?php
        foreach ($domande as $key => $request) {
            echo  $request["domanda"] . "<br>" . $request ["risposta"] ;
        }
        ?>
    </div>
</div>
